...
try:
    ...
    ring_flash_attn_qkvpacked_func=None
...
class MHA(nn.Module):
    def __init__(
        ...
        assert not sequence_parallel and temp_spatial_parallel, \
            "sequence_parallel and temp_spatial_parallel cannot be True at the same time"
        self.sequence_parallel = sequence_parallel
        self.parallel_group = parallel_group
        self.ring_attention = ring_attention
        self.temp_spatial_parallel = temp_spatial_parallel
